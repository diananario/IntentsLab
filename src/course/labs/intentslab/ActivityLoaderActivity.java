...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent i= new Intent(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
	...
	private void startImplicitActivation() {
		...
		chooserIntent= Intent.createChooser(Inte, CHOOSER_TEXT);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(requestCode==GET_TEXT_REQUEST_CODE){
			if(resultCode==RESULT_OK){
				mRespuesta= data.getStringExtra(ExplicitlyLoadedActivity.RESPUESTA);
				mUserTextView.setText(mRespuesta);
			}
		}
